...
Lead Software Engineer | Back-end Developer \\[6pt]
...
% ================= INTRODUÇÃO =================
\section*{Introdução}
Lead Software Engineer com mais de 5 anos de experiência no design, construção e escalabilidade de sistemas distribuídos em produção. Forte atuação em engenharia backend, microsserviços, processamento assíncrono e arquiteturas cloud-native. Histórico comprovado na recuperação de projetos críticos, aumento da confiabilidade de sistemas, redução de custos operacionais e entrega de soluções escaláveis sob restrições de prazo e contexto. Experiência com Go, Java, Node.js e Python, com foco em padrões de resiliência, clean architecture e performance.
